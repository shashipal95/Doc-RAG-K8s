...
export default function Login() {
  ...
  const handleForgotSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        setForgotStatus({ loading: false, message: "Reset link sent! Please check your email (including spam).", error: "" });
      } else {
        setForgotStatus({ loading: false, message: "", error: data.detail || "Request failed" });
      }
    } catch (err) {
      setForgotStatus({ loading: false, message: "", error: "Connection error" });
    }
  };
  ...
  return (
    <div style={{
      ...
      <div style={{ width: "100%", maxWidth: 440, position: "relative", zIndex: 1, marginTop: 40 }}>
        ...
        <div className="fade-up" style={{ textAlign: "center", marginBottom: 32 }}>
          ...
          <p style={{ color: "var(--c-text-muted)", fontSize: 13.5, fontWeight: 400 }}>
            Continue your document interactions
          </p>
        </div>
        ...
        <div className="fade-up fade-up-1 auth-card">
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline" }}>
                ...
                <button 
                  ...
                  style={{ background: "none", border: "none", padding: 0, fontSize: 11.5, color: "var(--c-accent)", cursor: "pointer", fontWeight: 600 }}
                >
                  Forgot?
                </button>
              </div>
              <div style={{ position: "relative" }}>
                <input
                  ...
                  style={{ height: 48, fontSize: 14.5, paddingRight: 48 }}
                />
                <button
                  type="button"
            ...
            >
              {loading ? "Authenticating..." : "Sign in to DocsChat →"}
            </button>
          </form>
          ...
          <div style={{ margin: "32px 0" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 24 }}>
              ...
              <span style={{ fontSize: 11, color: "var(--c-text-faint)", fontFamily: "var(--font-mono)", textTransform: "uppercase", letterSpacing: "0.05em" }}>Continue with</span>
              <div style={{ flex: 1, height: 1, background: "rgba(255,255,255,0.06)" }} />
            </div>
          ...
          <p style={{ textAlign: "center", fontSize: 13.5, color: "var(--c-text-faint)" }}>
            ...
            <Link href="/signup" style={{ color: "var(--c-accent)", textDecoration: "none", fontWeight: 600 }}>Create for free</Link>
          </p>
        </div>
      ...
      {showForgotModal && (
        <div style={{
          ...
          <div style={{
            width: "100%", maxWidth: 400, background: "var(--c-bg-card)", borderRadius: 20,
            border: "1px solid var(--c-border)", padding: 32, boxShadow: "0 20px 50px rgba(0,0,0,0.5)"
          }} onClick={e => e.stopPropagation()}>
            <h2 style={{ fontSize: 24, fontWeight: 700, color: "var(--c-text)", marginBottom: 8 }}>Reset Password</h2>
            ...
            <form onSubmit={handleForgotSubmit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              <div style={{ display: "flex", gap: 12 }}>
                ...
                <button
                  ...
                  style={{ flex: 1, height: 44 }}
                >
                  {forgotStatus.loading ? "Generating..." : "Generate Link"}
                </button>
              </div>
            </form>
          </div>
